export default class NupValidacao {
  numerobrutoString: string
  nup: string
  numeroSequencial: string
  digitoVerificador: string
  anoAjuizamento: string
  segmentoJustica: string
  tribunal: string
  unidadeOrigem: string
  numeroPreCalculoDigitoVerificador: string
  numeroPreCalculoDigitoVerificadorInt: bigint | number
  digitoVerificadorCalculado: string
  digitoVerificadorCalculadoInt: number
  validado: boolean

  constructor(numerobrutoString: string) {
